...
struct InputDefinitionTest < ASPEC::TestCase
  ...
  def test_option_defaults : Nil
    definition = ACON::Input::Definition.new(
      ...
      ACON::Input::Option.new("foo6", value_mode: ACON::Input::Option::Value::OPTIONAL | ACON::Input::Option::Value::IS_ARRAY),
      ACON::Input::Option.new("foo7", value_mode: ACON::Input::Option::Value::OPTIONAL | ACON::Input::Option::Value::IS_ARRAY, default: ["1", "2"]),
    )
  ...
  def synopsis_provider : Hash
    {
      ...
      "uses an ellipsis for required array arguments" => {ACON::Input::Definition.new(ACON::Input::Argument.new("foo", ACON::Input::Argument::Mode::REQUIRED | ACON::Input::Argument::Mode::IS_ARRAY)), "<foo>..."},
